...
const HighlightedEventCard = ({ event }) => {
  return (
    <Link to={`/highlighted/${event.id}`} className="block">
      <div className="relative w-[300px] h-[380px] rounded-lg shadow-lg overflow-hidden cursor-pointer transition-transform hover:scale-[1.02]">
